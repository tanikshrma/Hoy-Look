  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto z-10 w-full relative">
        ...
        <h2 className="text-2xl sm:text-4xl md:text-5xl lg:text-[54px] tracking-tight leading-[1.08] uppercase text-center">
        ...
        {/* Subheading */}
        <p className="mt-4 sm:mt-8 text-lg sm:text-2xl md:text-[26px] font-bold text-[#19120D] tracking-tight leading-snug">
          A better outfit is already in your wardrobe.
        </p>

        {/* Description */}
        <p className="mt-2 sm:mt-4 text-xs sm:text-base md:text-[16px] text-[#2C1E15] font-sans-body font-normal max-w-xl mx-auto leading-relaxed">

...
export const AIGenerateLooksStep: React.FC<AIGenerateLooksStepProps> = ({ onComplete }) => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto bg-white rounded-2xl sm:rounded-3xl border border-[#E8E2D9] p-5 sm:p-10 shadow-2xl animate-fade-in text-center">
      {/* Step Header */}
      <div className="mb-6 sm:mb-8 pr-6 sm:pr-0 pl-6 sm:pl-0">
